...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <link rel="apple-touch-icon" href="/images/logo_icon.svg">
    <meta name="apple-mobile-web-app-title" content="2DAWN">

    @php
      // 1. Determine the final logo URL
      $finalLogoUrl = '/images/logo_dark.svg'; // Default
      $absUrl = config('app.url') . '/images/logo_dark.svg';
    ...
    @php
      $orgJson = [
        ...
        'logo' => asset('images/logo_dark.svg'),
      ];
      $siteJson = [
        '@context' => 'https://schema.org',
        '@type' => 'WebSite',
