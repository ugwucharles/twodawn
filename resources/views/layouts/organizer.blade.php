...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased selection:bg-gray-200 selection:text-black">
        <div class="flex h-screen overflow-hidden">
            <!-- Sidebar -->
            <aside class="w-64 bg-gradient-to-br from-amber-50 to-amber-100 hidden lg:flex flex-col border-r border-amber-200/50 shrink-0">
                <!-- Logo -->
                <div class="p-8 flex items-center gap-2">
                    <img src="/images/logo.png" alt="2DAWN" class="h-10 w-auto">
                </div>
                ...
                <nav class="flex-1 px-4 space-y-8 overflow-y-auto">
                    <div>
                        ...
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a href="{{ route('organizer.events.index') }}" class="sidebar-link group flex items-center px-4 py-3 text-sm font-bold transition-all {{ request()->routeIs('organizer.events.*') ? 'active' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-xl' }}">
                                    <svg class="w-5 h-5 mr-3 transition-colors {{ request()->routeIs('organizer.events.*') ? 'text-black' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                                    Events
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('organizer.orders.index') }}" class="sidebar-link group flex items-center px-4 py-3 text-sm font-bold transition-all {{ request()->routeIs('organizer.orders.*') ? 'active' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-xl' }}">
                                    <svg class="w-5 h-5 mr-3 transition-colors {{ request()->routeIs('organizer.orders.*') ? 'text-black' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
                                    Orders
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul class="space-y-1">
                            <li>
                                <a href="{{ route('organizer.wallet.index') }}" class="sidebar-link group flex items-center px-4 py-3 text-sm font-bold transition-all {{ request()->routeIs('organizer.wallet.*') ? 'active' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-xl' }}">
                                    <svg class="w-5 h-5 mr-3 transition-colors {{ request()->routeIs('organizer.wallet.*') ? 'text-black' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path></svg>
                                    Wallet
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('organizer.settings.edit') }}" class="sidebar-link group flex items-center px-4 py-3 text-sm font-bold transition-all {{ request()->routeIs('organizer.settings.*') ? 'active' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-xl' }}">
