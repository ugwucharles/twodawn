<x-organizer-layout>
    <div class="max-w-7xl mx-auto mt-2">
        ...
        @if(!empty($event->must_know))
            <div class="mb-8 bg-gradient-to-r from-purple-50 to-purple-200 border border-purple-200 rounded-2xl p-6 shadow-[0_2px_10px_-3px_rgba(147,51,234,0.15)]">
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        <h3 class="text-base font-extrabold text-purple-800 tracking-wide mb-1">MUST KNOW!</h3>
                        <p class="text-sm text-purple-900/80 leading-relaxed whitespace-pre-line">{{ $event->must_know }}</p>
                    </div>
                </div>
            </div>
        @endif
