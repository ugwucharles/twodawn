  ...
  <div class="w-full px-4 md:px-6 lg:px-10 h-full flex items-center justify-between gap-4">
    ...
    <div class="flex items-center shrink-0">
      <a href="{{ url('/') }}" class="flex items-center">
        <img src="/images/logo.png" alt="{{ config('app.name', '2DAWN') }}" class="h-10 w-auto mix-blend-multiply object-contain" style="transform: scale(2.5); transform-origin: left center;">
      </a>
    </div>
