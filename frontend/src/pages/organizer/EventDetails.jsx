...
function EventDetails() {
  ...
  const printPDF = async () => {
    ...
    // Add Logo (SVG paths converted to Canvas to base64 PNG) with safety fallback
    try {
      await new Promise((resolve) => {
        ...
        img.onload = () => {
          try {
            ...
            console.error('Canvas conversion failed, drawing text logo fallback:', e);
      ...
      console.error('Logo Promise error, drawing text logo fallback:', err);
      doc.setFont('helvetica', 'bold');
      doc.setFontSize(28);
      doc.setTextColor(0, 0, 0);
      doc.text('2', 14, 20);
