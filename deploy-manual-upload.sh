...
# Laravel Deployment Script for Manual Uploads (No Git)
# Upload your files via cPanel File Manager to ~/repositories/2DAWN
# Then run this script in terminal

echo "🚀 Setting up Laravel after manual upload..."
